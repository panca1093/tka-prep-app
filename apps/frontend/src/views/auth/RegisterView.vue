...
.role-option.active { border-color: var(--accent); color: var(--accent); }
.role-sub { font-size: 0.72rem; font-weight: 400; color: var(--text-muted); margin-top: 2px; }
...
.pending-card p { color: var(--text-muted); font-size: 0.875rem; line-height: 1.6; margin: 0; }
</style>
